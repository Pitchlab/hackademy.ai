...
class miaHotword:
    def __init__(self):
      ...
      model_file='/home/pi/hackademy.ai/hackathons/hackathon_1_voice/resources/hotwords/computer.pmdl' # put your hotword file here. if you want to just try out use ./resources/snowboy.umdl
      sensitivity = 0.5
      ############### END OF MODIFY ##################
